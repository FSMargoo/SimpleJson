...
std::map<char, sJSONTokenType> sJSONTokenMap = {{'{', sJSONTokenType::BigLeft},	   {'}', sJSONTokenType::BigRight},
												{'[', sJSONTokenType::MiddleLeft}, {']', sJSONTokenType::MiddleRight},
												{',', sJSONTokenType::Comma},	   {':', sJSONTokenType::Colon}};
std::map<sJSONTokenType, char> sJSONTokenStringMap = {
	{sJSONTokenType::BigLeft, '{'},		{sJSONTokenType::BigRight, '}'}, {sJSONTokenType::MiddleLeft, '['},
	{sJSONTokenType::MiddleRight, ']'}, {sJSONTokenType::Comma, ','},	 {sJSONTokenType::Colon, ':'}};
std::map<sJSONTokenType, sJSONTokenType> sJSONOppsiteTokenMap = {
	{sJSONTokenType::BigLeft, sJSONTokenType::BigRight}, {sJSONTokenType::MiddleLeft, sJSONTokenType::MiddleRight}};
